		...
		<div class="row">
			<div class="col-md-12 text-center mt-5">
				<div class="col-md-6 offset-md-3">
					<h6 class="mb-1"><b>Lorem Ipsum</b></h6>
					...
					<br>
					<h6 class="mb-1"><b>Lorem Ipsum</b></h6>
					<h6 class="mb-1"><b>Lorem Ipsum dolor sit amet</b></h6>
					<h6 class="mt-0">Lorem ipsum</h6>
					...
					<br>
					<h6 class="mb-2"><b>Lorem Ipsum</b></h6>
					<h6 class="mt-0">Lorem ipsum dolor sit amet</h6>

					<h6 class="mb-2"><b>Lorem Ipsum</b></h6>
					<img src="assets/img/logo1.png" alt="" class="m-auto">

					<h6 class="mb-2"><b>Lorem Ipsum</b></h6>
					<img src="assets/img/logo2.png" alt="" class="m-auto">

					<h6 class="mb-2"><b>Lorem Ipsum</b></h6>
					<img src="assets/img/logo3.png" alt="" class="m-auto">

					<br><br>
					<h4 class="my-5">İLETİŞİM</h4>
